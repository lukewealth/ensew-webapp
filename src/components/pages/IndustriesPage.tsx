...
const industries = [
  ...
  { name: "Construction", icon: Construction, image: "https://images.unsplash.com/photo-1541888946425-d81bb19480c5?auto=format&fit=crop&q=80&w=800" },
  ...
  { name: "Industrial Supply", icon: Settings, image: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&q=80&w=800" },
      ...
      <main className="pt-20">
        ...
        <section className="py-24 bg-surface-dim">
          <div className="max-w-4xl mx-auto px-6 text-center glass-card p-16 rounded-3xl">
            ...
            <div className="mt-12">
               <Link href="/contact" className="gold-button px-10 py-4 text-navy font-poppins font-bold text-sm tracking-widest rounded-xl uppercase inline-block">
